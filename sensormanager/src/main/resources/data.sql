...
insert into sensor_spec (id, name, sensor_category) values ('sensor.10000db11e_h', 'Thermostat temperature', 0);
insert into sensor_spec (id, name, sensor_category) values ('sensor.10000db11e_t', 'Thermostat humidity', 1);
insert into sensor_spec (id, name, sensor_category) values ('sensor.10000db501_t', 'Water temperature', 0);
