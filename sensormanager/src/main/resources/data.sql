...
insert into sensor_spec (id, name, sensor_category) SELECT'sensor.10000db11e_h', 'Thermostat humidity', 1 WHERE NOT EXISTS (SELECT id FROM sensor_spec WHERE id = 'sensor.10000db11e_h');
insert into sensor_spec (id, name, sensor_category) SELECT'sensor.10000db11e_t', 'Thermostat temperature', 0 WHERE NOT EXISTS (SELECT id FROM sensor_spec WHERE id = 'sensor.10000db11e_t');
