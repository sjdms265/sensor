...
import com.sensor.temperaturesensor.TemperatureSensorApplication;
...
/*
    ...
    https://github.com/eugenp/tutorials/blob/master/spring-kafka/src/test/java/com/baeldung/kafka/streams/KafkaStreamsApplicationLiveTest.java
 */
@Testcontainers
@SpringBootTest(classes = TemperatureSensorApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class SensorValueChangeProcessorIntegrationTest {
